  ...
  const handleDeletePost = async (id: string) => {
    if (window.confirm("Da li ste sigurni da želite da obrišete ovaj blog post?")) {
      try {
        ...
        toast.success('Blog post uspešno obrisan');
      } catch (error) {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl md:text-3xl font-bold">Upravljanje blogovima</h1>
        <Button 
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Pretražite blog postove po naslovu ili autoru
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {loading ? 'Učitavanje...' : `Ukupno ${filteredPosts.length} blog ${filteredPosts.length === 1 ? "post" : "postova"}`}
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  filteredPosts.map((post) => (
                    <tr key={post.id} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        ...
                        >
                          {post.published ? 'Objavljen' : 'Nacrt'}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        {post.createdAt.toLocaleDateString('sr-RS')}
                      </td>
